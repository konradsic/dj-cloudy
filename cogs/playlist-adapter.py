...
class PlaylistGroupCog(commands.GroupCog, name="playlists"):
    ...
    @app_commands.command(name="add-song", description="Add a song to your playlist. Use starred in the name of playlist to add the song yo your starred-songs playlist")
...
async def setup(bot):
    ...
    help_utils.register_command("playlists add-song", 
        "Add a song to your playlist. Use starred in the name of playlist to add the song yo your starred-songs playlist", "Music: Playlist management", 
    ...
    help_utils.register_command("playlists remove-song", "Remove a song from your playlist", "Music: Playlist management", 
        [("name_or_id", "Name of the playlist you want to remove the song from", True),("index", "Index of the song you want to remove (1-playlist len)")])
